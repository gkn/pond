    ...
    describe("Pipeline event conversion", () => {
        ...
        it("should be able to convert from an Event to an TimeRangeEvent, using a duration, in front of the event", (done) => {
            ...
            Pipeline()
                ...
                .to(EventOut, event => {
                    expect(`${event}`).toBe(`{"timerange":[1426316400000,1426320000000],"data":{"value":3}}`);
                    done();
                });
            stream.addEvent(e);
        });
        ...
        it("should be able to convert from an Event to an TimeRangeEvent, using a duration, surrounding the event", (done) => {
            ...
            Pipeline()
                ...
                .to(EventOut, event => {
                    expect(`${event}`).toBe(`{"timerange":[1426314600000,1426318200000],"data":{"value":3}}`);
                    done();
                });
            stream.addEvent(e);
        });
        ...
        it("should be able to convert from an Event to an TimeRangeEvent, using a duration, in behind of the event", (done) => {
            ...
            Pipeline()
                ...
                .to(EventOut, event => {
                    expect(`${event}`).toBe(`{"timerange":[1426312800000,1426316400000],"data":{"value":3}}`);
                    done();
                });
            stream.addEvent(e);
        });
        ...
        it("should be able to convert from an Event to an IndexedEvent", (done) => {
            ...
            Pipeline()
                ...
                .to(EventOut, event => {
                    expect(`${event}`).toBe(`{"index":"1h-396199","data":{"value":3}}`);
                    done();
                });
            stream.addEvent(e);
        });
